...
<link rel="stylesheet" type="text/css" href="css/cartnbuy.css?ver=10"> 
...
<form action="orderResult.do" method="post" name="frm" onsubmit="return send_it();">
		...
		<br><div style="font-size: 20px;margin-left: 20px; margin-bottom: 10px " >주문리스트확인</div><br>
		<table class="info">
		<thead>
		<tr class="cart_tr"  >
		...
		<br><div style="font-size: 20px;margin-left: 20px; margin-bottom: 10px " >주문자정보입력</div><br>
		<table class="info" >
			<tr class="cart_tr" >
...
<%-- 			<tr class="info_tr">
			...
			<tr class="info_tr">
			 ...
			 <tr class="cart_tr">
			 	<td rowspan="2">주소</td>
			 	<td >
			 		<input type="text" name="spost" id="sample6_postcode" placeholder="우편번호" >
					<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기">
			<tr class="cart_tr">
				<td><input type="text" name="saddress" id="sample6_address" placeholder="주소">
					<input type="text" id="sample6_extraAddress" placeholder="참고항목" >
					<input type="text" name="saddress2" id="sample6_detailAddress" placeholder="상세주소" >
				</td>
			</tr>
			</tr>
 
			<tr class="class="cart_tr"" height="20px" >
		...
		<div>
<!--할인정보        -->
		<br><div style="font-size: 20px; margin-left: 20px; margin-bottom: 10px " >할인정보</div>
		<div>
		<table class="info">
			<tr class="cart_tr">
...
<!--결제내역      -->
		...
		<br><div style="font-size: 20px; margin-left: 20px; margin-bottom: 10px " >결제금액</div><br>
		<div>
		<table class="info">
			<tr  class="info_tr">
...
<!--결제 수단            -->
		<br><div style="font-size: 20px; margin-left: 20px; margin-bottom: 10px " >결제수단</div><br>
		<div>
		...
		<br>
<!--신용카드            -->
    <br><div id="showHide1" align="middle" style="display: none;">
		<div>
		<div  style="font-size: 20px; margin-left: 20px; margin-bottom: 10px; " >신용카드</div><br>
    ...
    <br> <div id="showHide2" align="middle" style="display: none;">
    	<div style="font-size: 20px; margin-left: 20px; margin-bottom: 10px; " >무통장입금</div><br>
		<div >
			<div style="text-align: left;">
			<h4>유의사항</h4>
