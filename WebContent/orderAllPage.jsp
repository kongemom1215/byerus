					...
					<table id="search_table">
						...
						<c:forEach var="order" items="${orderlist }">
							<tr>
								...
								<td><a href="orderSelectInfo.do?oid=${order.oid }" style="text-decoration: underline;"> <fmt:formatDate pattern="yyyyMMdd" value="${order.odate }"/>-<fmt:formatNumber value="${order.oid }" pattern="00000"/></a></td>
								<td>${order.sname }</td>
