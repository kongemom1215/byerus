...
public class QnaWaitAction implements CommandProcess {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			int totalWait=qd.totalWait();
			int startNum=totalWait-startRow+1; //시작 게시글번호
			List<Qna> waitlist=qd.waitlist(startRow, endRow);
			...
			System.out.println("QnaWaitAction -> "+e.getMessage());
		}
		return "qnaWait.jsp";
	}
