...
public class MypageReviewAction implements CommandProcess {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			List<Board> list = bd.review_list(sid,startRow, endRow);
			int cntReview = bd.getCount_R(sid);
			
			System.out.println();
			
			
			int pageCnt=(int)Math.ceil((double)cntReview/pageSize);
			...
			request.setAttribute("cntReview", cntReview);
		} catch (Exception e) {
			System.out.println("MypageReviewAction error=> "+e.getMessage());
		} 
		 
		return "mypageReview.jsp";
	}
